...
public class MCreatorLibrito extends Elementsshitposting_colombian.ModElement {
	public static EntityType entity = null;

	public MCreatorLibrito(Elementsshitposting_colombian instance) {
		super(instance, 8);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity> create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(CustomEntity::new).size(0.4f, 0.3f)).build("librito")
				.setRegistryName("librito");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("librito"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(CustomEntity.class, renderManager -> {
			MobRenderer customRender = new MobRenderer(renderManager, new SilverfishModel(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("shitposting_colombian:textures/s_k_i_n.png");
				}
			};
			return customRender;
		});
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Items.BOOK, (int) (1)));
		}
