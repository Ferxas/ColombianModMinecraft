...
public class MCreatorMarihuana extends Elementsshitposting_colombian.ModElement {
	@ObjectHolder("shitposting_colombian:marihuana")
	public static final Block block = null;

	public MCreatorMarihuana(Elementsshitposting_colombian instance) {
		super(instance, 7);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		FlowersFeature feature = new FlowersFeature(NoFeatureConfig::deserialize) {
			...
			public boolean place(IWorld world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
				...
				if (dimensionType == MCreatorLaSelvaDeLasFarc.type)
					dimensionCriteria = true;
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.GROUND)
					.hardnessAndResistance(1f, 0f).lightValue(0));
